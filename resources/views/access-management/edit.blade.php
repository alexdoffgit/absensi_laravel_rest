<x-layout title="Access Management | Edit">
    <div class="container">
        <div class="mx-auto" style="width: 50%;">
            ...
            <form action="/access-management/new" method="POST" class="border rounded">
                ...
                <div class="mt-3 mb-3 mx-3">
                    ...
                    <input type="text" name="menu-path" id="menu-path" class="form-control" required value="{{ $formData['menu_path'] }}">
                </div>
                <div class="mt-3 mb-3 mx-3">
                    <label for="menu-name" class="form-label">Menu Name</label>
                    <input type="text" name="menu-name" id="menu-name" class="form-control" value="{{ $formData['menu_name'] }}">
                </div>
                <div class="mb-3 mx-3">
                    <label for="laravel-controller-class" class="form-label">Laravel Controller Class</label>
                    <input type="text" name="laravel-controller-class" id="laravel-controller-class" class="form-control" required value="{{ $formData['laravel_controller_class'] }}">
                </div>
                <div class="mb-3 mx-3">
                    <label for="laravel-controller-method" class="form-label">Laravel Controller Method</label>
                    <input type="text" name="laravel-controller-method" id="laravel-controller-method" class="form-control" required value="{{ $formData['laravel_controller_method'] }}">
                </div>
                <div class="mb-3 mx-3">
                    <label for="laravel-middleware" class="form-label">Laravel Middleware</label>
                    <input type="text" name="laravel-middleware" id="laravel-middleware" class="form-control" required value="{{ $formData['laravel_middleware'] }}">
                </div>
                <div class="mb-3 mx-3">
